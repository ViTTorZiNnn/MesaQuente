export const BUILD='MESA VIVA 05';
const get=(key,fallback)=>{try{return localStorage.getItem(key)||fallback;}catch{return fallback;}};
export const visual={scene:get('mq_scene','galaxia'),motion:get('mq_motion','auto')};
